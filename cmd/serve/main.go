...
func NewSentry(logger *zap.Logger) (*sentryhttp.Handler, error) {
	err := sentry.Init(sentry.ClientOptions{})
	if err != nil {
		logger.Error(fmt.Sprintf("sentry.Init: %s", err))
		return nil, err
	}
...
// necessary.
func NewHandler(sentryHandler *sentryhttp.Handler, c *ent.Client, logger *zap.Logger) (http.Handler, error) {
